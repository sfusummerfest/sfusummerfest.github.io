...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-between min-h-screen space-y-8">
      <header className="h-screen relative w-full">
        <div className="absolute h-full left-0 top-0 w-full" id="home-bg-video-container">
        ...
        <div className="absolute bg-black h-full left-0 opacity-70 top-0 w-full"></div>
        <div className="absolute flex flex-col h-full items-center justify-center left-0 top-0 w-full">
          <div className="max-w-4xl">
            <Image src={logoImage} alt="Logo of The Summer Festival presented by SFU Anime" unoptimized></Image>
          </div>
          <Link href="#home-main">
            <button className="active:bg-primary-purple active:border-primary-yellow active:text-primary-yellow bg-primary-red border-4 border-white font-bold hocus:bg-primary-purple hocus:border-primary-yellow hocus:text-primary-yellow px-8 py-4 rounded-full text-white">
              Enter
            </button>
          </Link>
        </div>
      ...
      <main className="max-w-screen-lg px-2 space-y-4" id="home-main">
        <section className="border-4 border-primary-red p-2 rounded-xl space-y-4">
          <div>
          ...
          <div className="leading-normal space-y-2 text-lg">
            ...
            <p>
              Due to challenges presented with preparations and regulatory requirements, we will <b>not</b> be hosting the SFU Summer Festival for 2023.
        ...
        <section className="border-4 border-primary-red p-2 rounded-xl space-y-4">
          ...
          <div className="h-full w-full">
            <iframe width="100%" height="576px" src="https://www.youtube.com/embed/vAZB4xjWcdc" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
          </div>
        </section>
      </main>
      <footer className="bg-primary-dark flex flex-col items-center justify-between space-y-8 w-full">
        ...
        <section>
          <p className="text-gray-500 text-xs">&copy; SFU Summer Festival 2022-2023</p>
        </section>
      </footer>
    </div>
  )
